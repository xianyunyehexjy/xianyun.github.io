module.exports = {
	...
	head: [
		...
		[
			'link',
			{ rel: 'stylesheet', href: '/live2dModels/live2d/css/common.css' },
		], //引入css
		['link', { rel: 'stylesheet', href: '/css/APlayer.min.css' }], //引入css
		[
			'script',
			{ type: 'text/javascript', src: '/live2dModels/live2d/js/live2d.js' },
		], //引入live2d
		[
			'script',
			{ type: 'text/javascript', src: '/live2dModels/live2d/js/init.js' },
	...
	globalUIComponents: ['player', 'card'],
};
